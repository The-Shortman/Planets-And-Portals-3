...
This is the official online Git repository for the Planets And Portals 3 modpack, soon to be available on CurseForge. Please read the [CONTRIBUTING file](https://github.com/The-Shortman/Planets-And-Portals-3/blob/dev/CONTRIBUTING.md) before opening an issue or pull request.

<div align="center">
	<h2>Planets And Portals 3 is a fresh take on modern automation modpacks</h2>
</div>

A summary of the modpack will appear here eventually.
