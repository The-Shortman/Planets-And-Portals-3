...
(function villagerTradeReplacements() {
  function replaceVillagerTrades(entity) {
    // This replaces all emeralds with numismatic coins and tries to put them to their roundest equivalent currency
  ...
  ItemEvents.entityInteracted((event) => {
    if (
      event.target.type == "minecraft:villager" ||
      event.target.type == "minecraft:wandering_trader" ||
      event.target.type == "ad_astra:lunarian" ||
      event.target.type == "ad_astra:lunarian_wandering_trader"
    ) {
